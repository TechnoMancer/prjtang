...
colours = {"a": "#88FFFF", "b": "#FF88FF", "c": "#8888FF", "d": "#FFFF88", "m": "#FFBBBB", "e": "#BBBBFF",
           "w": "#FFFFBB", "n": "#BBFFFF", "s": "#FFBBBB"}
...
def main(argv):
    ...
    tdb = pytang.get_tile_bitdata(
        pytang.TileLocator(args.family, args.device, args.tile))
    ch = pytang.Chip(args.device)
